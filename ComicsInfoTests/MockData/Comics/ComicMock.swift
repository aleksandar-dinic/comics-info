...
struct ComicMock {
    ...
    static let comicsInfoComics = [
        Comics_Info__Development_.Comic.make(identifier: "1", popularity: 1, title: "Spider-Man"),
        Comics_Info__Development_.Comic.make(identifier: "2", popularity: 2, title: "Duel to the Death with the Vulture!"),
        Comics_Info__Development_.Comic.make(identifier: "3", popularity: 3, title: "Spider-Man Versus Doctor Octopus")
    ]
